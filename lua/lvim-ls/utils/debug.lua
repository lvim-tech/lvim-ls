-- lvim-ls: file-based debug logging utility.
-- Writes timestamped log lines to stdpath("state")/lvim-ls/debug.log.
...
--
---@module "lvim-ls.utils.debug"

local levels = require("lvim-ls.utils.levels")
